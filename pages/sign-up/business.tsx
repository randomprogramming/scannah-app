...
export default function Business() {
  ...
  const companyName = useAppSelector((state) => state.signUpScreen.companyName);
  const companyWebsite = useAppSelector(
    (state) => state.signUpScreen.companyWebsite,
  );
          ...
          <div className="flex flex-row">
            <div className="flex-1">
              ...
              <p className="text-secondary">
                Start rewarding your customers for free!
              </p>
            </div>
            <div>
              <Link href="/">
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <div className="w-full">
                    <Input
                      ...
                      value={companyName}
                      onChange={(newVal: string) =>
                        dispatch(setCompanyName(newVal))
                      }
                      validateLength
                    />
                  </div>
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <div className="w-full">
                    <Input
                      ...
                      onChange={(newVal: string) =>
                        dispatch(setCompanyWebsite(newVal))
                      }
                    />
                  </div>
                </div>
                <div>
                  <span>Only want to collect points? </span>
                  <Link href="/sign-up">
                    <a>
                      <StyledLinkSpan>
                        Click here to create a non-business account.
                      </StyledLinkSpan>
                    </a>
                  </Link>
                </div>
